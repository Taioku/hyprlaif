...
```
yay -S --noconfirm eza wget mplayer fastfetch hyprpaper networkmanager overskride ttf-martian-mono-nerd noto-fonts noto-fonts-cjk nwg-look gnome-themes-extra gtk-engine-murrine sassc waypaper lolcat pipes.sh bonsai.sh asciiquarium cava cxxmatrix feh
