...
```
yay -S --noconfirm eza fastfetch hyprpaper ttf-martian-mono-nerd noto-fonts noto-fonts-jp-vf nwg-look gnome-themes-extra gtk-engine-murrine sassc waypaper lolcat pipes.sh bonsai.sh asciiquarium genact cava feh
hyprpm update
